...
$title  = "Tambah Customer - MyMoro Baby Store";
...
if (isset($_POST['simpan'])){
    if (insert($_POST)){
        echo "
            <script>document.location.href = 'data-customer.php?msg=simpan';</script>
            ";
    }
}
                            ...
                            <div class="col-lg-8 mb-3">
                              <?php if ($alert != ''){
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="ketr" id="ketr" rows="2" class="form-control" placeholder="keterangan customer" required></textarea>
                                </div>
                                <div class="form-group">
