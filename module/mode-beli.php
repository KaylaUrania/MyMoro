...
function totalBeli($nobeli){
    ...
    $totalBeli = mysqli_query($koneksi, "SELECT IFNULL(SUM(jml_harga), 0) AS total FROM tbl_beli_detail WHERE no_beli = '$nobeli'");
...
function simpan($data){
    ...
    $sqljual = "INSERT INTO tbl_beli_head VALUES ('$nobeli', '$tgl', '$supplier', $total, '$keterangan')";
