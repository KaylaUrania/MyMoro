...
$title = "Change Password - MyMoro Baby Store";
            ...
            <div class="card">
                <form action="" method="post">
                    <div class="card-header">
                        ...
                        <button type="submit" name="simpan" class="btn btn-primary btn-sm float-right"> <i class="fa fa-edit"></i> Submit</button>
                        <button type="reset" name="reset" class="btn btn-danger btn-sm float-right mr-1"> <i class="fa fa-times"></i> Reset</button>
                    </div>
                    <div class="card-body">
