...
$title  = "Edit Supplier - MyMoro Baby Store";
            ...
            <div class="card">
                <form action="" method="post">
                  <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-pencil-alt"></i> Edit Supplier</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="ketr" id="ketr" rows="2" class="form-control" placeholder="keterangan supplier" required><?= $supplier['deskripsi'] ?></textarea>
                                </div>
                                <div class="form-group">
